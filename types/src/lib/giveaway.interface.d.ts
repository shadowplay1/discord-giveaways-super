import { IGiveawayEmbedOptions, IGiveawayButtonOptions, IGiveawayStartMessages, IGiveawayRerollMessages } from '../types/configurations';
 ...
 * @prop {IGiveawayMessageProps} messageProps The message data properties for embeds and buttons.
 */
export type GiveawayWithoutInternalProps = Omit<Record<keyof IGiveaway, string>, 'entriesArray' | 'state' | 'isEnded'>;
/**
