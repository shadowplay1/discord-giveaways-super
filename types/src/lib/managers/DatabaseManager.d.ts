...
export declare class DatabaseManager<TDatabaseType extends DatabaseType, TKey extends string, TValue> {
     ...
     */
    set<V = TValue, R = any>(key: TKey, value: V, sendDebugLog?: boolean): Promise<R>;
    /**
     * Clears the database.
     * @param {boolean} [sendDebugLog=true] Whether the debug log should be sent in the console if debug mode is enabled.
     ...
     */
    add(key: TKey, numberToAdd: number): Promise<boolean>;
    /**
     ...
     */
    subtract(key: TKey, numberToSubtract: number): Promise<boolean>;
    /**
     ...
     */
    push<V = TValue>(key: TKey, value: V): Promise<boolean>;
    /**
     ...
     */
    pull<V = TValue>(key: TKey, index: number, newValue: V): Promise<boolean>;
    /**
     ...
     */
    pop(key: TKey, index: number): Promise<boolean>;
    /**
