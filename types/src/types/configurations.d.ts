 ...
 */
export type IGiveawayData = Omit<IGiveaway, 'id' | 'startTimestamp' | 'endTimestamp' | 'endedTimestamp' | 'messageID' | 'messageURL' | 'entriesCount' | 'entriesArray' | 'state' | 'messageProps' | 'isEnded'>;
/**
 ...
 */
export type IGiveawayStartConfig = OptionalProps<IGiveawayData, 'time' | 'winnersCount'> & Partial<IGiveawayStartOptions>;
/**
 ...
 * @template IsTemplate Determine if the specified giveaway object is a template object.
 */
export type GiveawayFinishCallback<IsTemplate extends boolean = false> = (winnersMentionsString: If<IsTemplate, '{winnersString}', string>, winnersCount: If<IsTemplate, '{numberOfWinners}', number>) => Partial<IGiveawayStartMessages>;
/**
 * An object that contains messages that are sent in various giveaway cases, such as end with winners or without winners.
 ...
 * @template IsTemplate Determine if the specified giveaway object is a template object.
 */
export type GiveawayRerollCallback<IsTemplate extends boolean = false> = (winnersMentionsString: If<IsTemplate, '{winnersString}', string>, winnersCount: If<IsTemplate, '{numberOfWinners}', number>) => Partial<IGiveawayRerollMessages>;
/**
