 ...
 */
export declare class Giveaways<TDatabaseType extends DatabaseType, TDatabaseKey extends string = `${string}.giveaways`, TDatabaseValue = IDatabaseStructure> extends Emitter<IGiveawaysEvents<TDatabaseType, TDatabaseKey, TDatabaseValue>> {
    /**
     * Discord Client.
     * @type {Client<boolean>}
     */
     ...
     */
    start<HostMemberID extends string = string, ChannelID extends string = string, GuildID extends string = string>(giveawayOptions: IGiveawayStartConfig<HostMemberID, ChannelID, GuildID>): Promise<SafeGiveaway<Giveaway<TDatabaseType>>>;
    /**
